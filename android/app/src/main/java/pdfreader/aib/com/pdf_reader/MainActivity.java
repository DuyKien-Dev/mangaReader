...
import com.bjvpbsdiwc.adx.service.InterstitialAdsManager;
...
public class MainActivity extends FlutterActivity implements RatingDialog.RatingDialogInterFace {
  ...
  protected void onCreate(Bundle savedInstanceState) {
              ...
              public void onMethodCall( MethodCall methodCall, MethodChannel.Result result) {
                ...
                switch(methodCall.method) {
                  ...
                  case "getThum":
                    ...
                    generateImageFromPdf(myUri,name,result);
                    break;
                  case "rate":
                    showRateDialog();
                    break;
    ...
    adsManager.init(true,this, "ca-app-pub-3005763564244697/4009165375","#5DE3FD","PDF Reader");
//    rateAutoAfterRun();
  ...
  void generateImageFromPdf(Uri pdfUri, String name, MethodChannel.Result result) {
...
//      Log.d("image:", "saveImage0: ");
  ...
  private void saveImage(Bitmap bmp,String name, MethodChannel.Result result) {
    FileOutputStream out = null;
    try {
      File folder = new File(FOLDER);
      if(!folder.exists())
        folder.mkdirs();
      File file = new File(folder, "PDF"+name+".png");
